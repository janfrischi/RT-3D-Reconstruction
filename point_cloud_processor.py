...
class CameraManager:
    def __init__(self, sn_cam1, sn_cam2, init_params1, init_params2):
        ...
        self.init_params1 = self._get_init_params(sn_cam1, init_params1)
        self.init_params2 = self._get_init_params(sn_cam2, init_params2)
        self._open_cameras()
        self._get_calibration_params()

    def _get_init_params(self, serial_number, custom_params):
    ...
    def get_calibration_params(self):
        return self.calibration_params1, self.calibration_params2
...
class MainApp:
    ...
    def run(self):
        ...
        while key != ord('q'):
            ...
            dict1, dict2, pcs1, pcs2, fused_pc = self.pc_processor.fuse_point_clouds_centroid(point_clouds_camera1, point_clouds_camera2, distance_threshold=0.3)
